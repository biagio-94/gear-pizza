-- 1) Funzione per estrarre colonne e tipi (get_schema_info)
...
-- 2) Funzione per estrarre enum (get_enum_types)
...
-- 3) Grant dei permessi (importante per poterle leggere via anon key)
